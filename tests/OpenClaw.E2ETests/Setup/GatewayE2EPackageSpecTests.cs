...
public sealed class GatewayE2EPackageSpecTests
{
    ...
    public void Resolve_AcceptsBuiltPackageUrl()
    {
        ...
        Assert.Equal(packageSpec, GatewayE2EPackageSpec.Resolve(
            "composed", packageSpec, ComposedSha256, ComposedHostDistro, "2099.1.3+proof.1", FallbackLkg));
        Assert.Equal(
            "2099.1.3+proof.1",
    ...
    [InlineData("composed", "2099.1.3-beta.2+proof.1", "2099.1.3-beta.2+proof.1")]
