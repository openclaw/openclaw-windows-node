...
internal sealed class BootstrapTokenLifecycle
{
        ...
        string identityPath)
    {
        ...
        {
            // Preserve the existing in-memory behavior: the canonical record remains
            // cleared even if persisting that clear fails, while diagnostics expose it.
            _logger.Warn(
