...
// SetupPairingCredentialPolicy and WindowsGatewayReachability are used by both PairOperatorStep
// and PairNodeStep (2 call sites each — grep-confirmed), not just one, so per the file-split
// plan's co-location rule they stay here as shared helpers rather than moving into either step's
// own file.
