...
public static class GatewayMediaMessageProjection
{
    ...
    /// <summary>
    /// Normalizes text for echo-correlation comparisons: trims, strips the
    /// tray's private attachment marker syntax, and caps length identically
    /// to how the reducer bounds rendered entries so local/remote copies of
    /// the same message always compare equal.
    /// </summary>
