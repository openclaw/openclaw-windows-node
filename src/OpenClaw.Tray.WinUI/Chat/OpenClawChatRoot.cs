    ...
    public override Element Render()
    {
        ...
        Element composer = effectiveThread is { } composerThread
            ? Component<OpenClawComposer, OpenClawComposerProps>(new(
                ...
                OnThinkingLevelChanged: level => ObserveFireAndForget(_provider.SetThinkingLevelAsync(composerThread.Id!, level)),
                OnThinkingLevelCleared: () => ObserveFireAndForget(_provider.ClearThinkingLevelAsync(composerThread.Id!)),
